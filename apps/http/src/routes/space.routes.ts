...
import { AddElementSchema, CreateElementSchema, CreateSpaceSchema, DeleteElementSchema } from "../types/index.types";
...
spaceRouter.post("/", userMiddleware, async (req, res) => {
    ...
    console.log(map.mapElements.length)
    let space = await client.$transaction(async () => { //transaction used for the loading the balance for large data.
        const space = await client.space.create({
            data: {
                name: parsedData.data.name,
                width: map.width,
